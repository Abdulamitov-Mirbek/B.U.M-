...
const categories = {
  ...
  ky: [
    {
      id: "consumer",
      title: "Керектөөчү кредит",
      subtitle: "Чекене каржылоо",
      description:
        "Жеке максаттар, оңдоо, билим алуу же саякат үчүн ийкемдүү каржылоого муктаж болгон кардарлар үчүн.",
    },
    {
      id: "auto",
      title: "Автоунаа кредити",
      subtitle: "Мобилдүүлүктү каржылоо",
      description:
        "Автоунаа сатып алууну пландап жаткан кардарлар үчүн өзүнчө маршрут.",
    },
    {
      id: "business",
      title: "Бизнес-кредит",
      subtitle: "Өсүү үчүн капитал",
      description:
        "Кеңейтүүгө, жүгүртүүдөгү каражаттарга же өнүктүрүүгө муктаж болгон ишкерлер жана чакан бизнес үчүн.",
    },
    {
      id: "premium",
      title: "Premium line",
      subtitle: "Приоритеттүү банктык продукт",
      description:
        "Көбүрөөк лимит жана премиум мамилеге муктаж болгон күчтүү профили бар кардарлар үчүн.",
    },
  ],
} as const;
...
const text = {
  ...
  ky: {
    ...
    admin: "Админ панели",
    logout: "Чыгуу",
    title: "Скоринг өтүнмөсүнүн алдында банктык продуктуну тандаңыз",
    description:
      "Биринчи кезекте кардар кредиттик категорияны тандайт. Бул колдонуучунун жолун бирдиктүү форма катары эмес, чыныгы санариптик банк сценарийи катары көрсөтөт.",
    products: "Кредиттик продуктулар",
    continue: "Улантуу",
    product: "Продукт",
  },
} as const;
