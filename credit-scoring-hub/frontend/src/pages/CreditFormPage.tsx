...
const categoryMeta = {
  ...
  ky: {
    consumer: {
      title: "Керектөөчү кредит үчүн өтүнмө",
      description:
        "Тең салмактуу скорингдик сценарийи бар жеке каржылоо.",
    },
    auto: {
      title: "Автоунаа кредити үчүн өтүнмө",
      description:
        "Төлөө жөндөмдүүлүгүн стандарттык текшерүү менен автоунааны каржылоо үчүн продукт.",
    },
    business: {
      title: "Бизнес-кредит үчүн өтүнмө",
      description:
        "Бизнестин өсүшү, жүгүртүүдөгү каражаттар жана кеңейтүү үчүн сценарий.",
    },
    premium: {
      title: "Premium credit line үчүн өтүнмө",
      description:
        "Күчтүү профили бар кардарлар үчүн приоритеттүү продукт.",
    },
    selected: "Тандалган категория",
