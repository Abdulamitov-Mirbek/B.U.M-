...
const content = {
  ...
  ky: {
    ...
    welcome: "Кош келиңиз",
    badge: "Urban Digital Lending",
    title: "Заманбап санариптик кредиттик платформа",
    description:
      "Кардар каттоодон өтүп, продуктуну тандап, андан кийин гана скорингге жана кредиттик чечимге өтүүчү премиум санариптик процесс.",
    primary: "Аккаунт ачуу",
    secondary: "Продукцияларды көрүү",
    productsTitle: "Продукциялар",
    products: [
      "Жеке каржылык максаттар үчүн керектөөчү кредиттер",
      "Атайын продукт агымы менен автоунаа кредиттөө",
      "Ишкерлер жана чакан бизнес үчүн бизнести каржылоо",
      "Күчтүү карыз алуучулар үчүн премиум линия",
    ],
    metricsTitle: "Платформанын артыкчылыктары",
    metrics: [
      "24/7 каттоо жана продукт кабыл алуу",
      "Бир платформада скоринг, API жана аналитика",
      "Категорияга негизделген кредиттөө тажрыйбасы",
    ],
    flowTitle: "Кардардын жолу",
    flow: [
      "Landing page банк жана продукциялар менен тааныштырат.",
      "Каттоо же кирүү санариптик кардардын аймагын ачат.",
      "Кардар тиешелүү кредиттик категорияны тандайт.",
      "Өтүнмө скоринг кыймылдаткычына берилет.",
    ],
  },
};
